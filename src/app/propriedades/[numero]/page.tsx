...
<div className="space-y-8">
  {sections.map(({ title, indices }) => (
    <section key={title}>
      ...
      <div className="flex flex-wrap justify-start gap-x-6 gap-y-4 text-white">
                {indices.map(idx => (
                  <div key={idx} className="flex items-center justify-start space-x-2 whitespace-nowrap">
